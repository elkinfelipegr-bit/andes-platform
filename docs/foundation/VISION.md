...
VISION.md answers _where we are going_. [MISSION.md](MISSION.md) answers _what we are building right now to get there_. [PRODUCT_STRATEGY.md](PRODUCT_STRATEGY.md) answers _in what order_.

...
| `docs/sprints/`      | Sprint plans and retrospectives                                                               | 🔶 Active — Sprints [0](../sprints/sprint-0.md)–[8](../sprints/sprint-8.md) and [10](../sprints/sprint-10.md) closed; [Sprint 9](../sprints/sprint-9.md) executed, closure pending Copilot activation |

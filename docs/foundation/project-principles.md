...
This document governs _how the project itself is run_: who decides what, how documentation works, and what language we write in. It is distinct from [engineering-principles.md](engineering-principles.md), which governs how engineering _work_ is executed once these rules are in place.

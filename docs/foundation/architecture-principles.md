...
**Editorial note:** See the boundary note in [engineering-principles.md](engineering-principles.md). This document covers _system structure_ — how the software itself is organized — not workflow or process.
